...
const TextPost = ({ handleClose }) => {
	...
	const handleSubmitPost = () => {
		if (createPost.title.length === 0 || createPost.content.length === 0)
			return;
		// let newTags = tags
		//     .trim()
		//     .split('#')
		...
		axios
			.post(
				"https://blooming-woodland-68246.herokuapp.com/post/create",
				{ title: createPost.title, content: createPost.content },
				{
					headers: {
						Authorization:
							"Bearer " + JSON.parse(localStorage.getItem("tumblrUser")).token,
		...
		<div className={styles.main}>
			<div className={styles.textDiv}>
				<div className={styles.diff}>
					<img
						src={
							currUser?.avatar?.length > 0 ? currUser.avatar : "download.png"
						}
						alt=""
					/>
				</div>
