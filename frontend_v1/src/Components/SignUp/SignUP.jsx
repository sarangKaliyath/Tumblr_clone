...
export default function SignUp() {
	...
	const handleRegister = () => {
		...
		axios
			.post("https://blooming-woodland-68246.herokuapp.com/register", {
				input,
			})
			.then((res) => {
				setError(false);
	...
	const handleGoogleAuth = () => {
		//  axios.get("https://blooming-woodland-68246.herokuapp.com/auth/google").then((res) => {
		//         setError(false);
		//         console.log(res.data);
		//     }).catch((err) => {
		//       console.log(err);
		...
		window.location.href =
			"https://blooming-woodland-68246.herokuapp.com/auth/google";
	};
